        ...
        <div class="card-body">
            ...
            <div id="form-password" class="form-group row">
                ...
                <div class="col-sm-10 col-content">
                    ...
                    @else
                        <small class="form-text text-muted">
                            <i class="fa fa-question-circle" aria-hidden="true"></i> Your password, this password for login.
                        </small>
                    @endif
...
@section('js')
    <script src="{{ asset('js/backend/profile/form.js'). '?v=' . rand(99999,999999) }}"></script>
@stop
