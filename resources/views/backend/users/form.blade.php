...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row {{ $data->role == '1' ? 'hide' : '' }}" id="branch-form">
                <div class="col-sm-2 col-form-label">
                    <strong class="field-title">Branch</strong>
                </div>
                <div class="col-sm-10 col-content">
                    {{ Form::select('id_branch', $branch, $branch == null ? 'Administrator Branch' :  $data->id_branch, array('id' => 'id_branch', 'class' => 'form-control', 'placeholder' => 'Please Choose Branch')) }}
                    <small id="passwordHelpBlock" class="form-text text-muted">
