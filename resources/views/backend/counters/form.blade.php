...
<!-- page title -->
@section('title', 'Create and Update Counters ' . Config::get('adminlte.title'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-content">
                    ...
                    <small id="passwordHelpBlock" class="form-text text-muted">
                        <i class="fa fa-question-circle" aria-hidden="true"></i> Name of your counter. Ex: Counter 1, or Room 1.
                    </small>
                </div>
            </div>
            <div class="form-group row">
...
@section('js')
    ...
    <script src="{{ asset('js/backend/counters/form.js'). '?v=' . rand(99999,999999) }}"></script>
@stop
